...
pub fn rescale(a: u64, inp_mod: u64, out_mod: u64) -> u64 {
    ...
    // println!("val: {}", val);
    // println!("sign * (inp_mod_i64 / 2): {}", (sign * (inp_mod_i64 / 2)));
    // println!("sign * (inp_mod_i64 / 2) as i128: {}", (sign * (inp_mod_i64 / 2)) as i128);

    // println!("val + sign * (inp_mod_i64 / 2) as i128: {}", val + (sign * (inp_mod_i64 / 2)) as i128);
...
mod test {
    ...
    fn rescale_test() {
        ...
        // let res = rescale(3, 21, 17);
        // println!("rescale(3, 21, 17) --> {}", res);


        // let res = rescale(1, 17, 21);
        // println!("rescale(1, 17, 21) --> {}", res);

        // // some bigprime and randomTest

        // let mut rng = thread_rng();
        
        // let inp_mod = 0x7fffffd8001 as u64;
        // let out_mod = 0x7fffffc8001 as u64;
        ...
        //     let res = rescale(a as u64, inp_mod, out_mod);
        //     println!("res: {}", res);
        // }

        let modulus = 66974689739603969 as u64;
        let ptModulus = 256 as u64;
        let val = 33487344869801984 as u64;

        let res = rescale(val, modulus, ptModulus);
        ...
        // println!("{:X}", -8572760286669308160 as i128);

        // println!("{:X}", -33487344869801984 as i128);

        // let val = 0xFFFFFFFFFFFFFFFFF8890776081107F0 as i128;

        // let val = u128::from_str_radix("FFFFFFFFFFFFFFFFF8890776081107F0", 16).unwrap();
        //  println!("{}", val.unwrap())
    ...
    fn reverse_bits_test() {
        ...
        // for i in 0..(1 << bit_count) - 1 {
 
        //     let reversed = reverse_bits(i, bit_count);

        //     println!("reversed({}, {}): {}", i, bit_count, reversed);
        // }
    ...
    #[test]
    fn div2_uint_mod_test() {

        let modulus = 17 as u64;

        for i in 0..modulus {
            let res = div2_uint_mod(i, modulus);
            println!("{}/2   mod {}: {}", i, modulus, res);
        }
