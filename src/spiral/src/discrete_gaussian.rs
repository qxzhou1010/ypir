...
impl DiscreteGaussian {
    ...
    pub fn sample(&self, modulus: u64, rng: &mut ChaCha20Rng) -> u64 {
        ...
        let len: usize = (2 * self.max_val + 1) as usize;
        let mut to_output = 0;
        ...
        for i in (0..len).rev() {
            ...
            // 怎么感觉和注释的逻辑对不上 
            // sampled_val <= point ---> 0 ---> !0 --> 1 ---> to_output = out_val 
            // sampled_val > point ---> 1 ----> !1 --> 0 ----> to_output = to_output 
            // 我擦，最外面取了一个反 
...
mod test {
    ...
    fn test_ct_gt() {
        ...
        out.conditional_assign(&in1, cmp);
